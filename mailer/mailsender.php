...
function send_mail($email, $oggetto, $messaggio, $path_allegato = null){
        ...
        $mail->Username = "help.lifething@gmail.com"; //la vostra mail
        $mail->Password = "SALVIBOX"; //password per accedere alla vostra mail
        $mail->Priority    = 1; //(1 = High, 3 = Normal, 5 = low)
        $mail->setFrom('help.lifething@gmail.com', 'LifeThing.it'); //impostazione del mittente
